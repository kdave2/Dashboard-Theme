    ...
    $.fn.columnFilter = function (options) {
        ...
        function _fnColumnIndex(iColumnIndex) {
            if (properties.bUseColVis)
                ...
                // modified to fix text search column issue where text box in column1 was searching from column2 due to hiding of column1
...
//                    }
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex) {
            ...
            select.change(function () {
                ...
                //alert(removeSpecialCharacters($(this).val().trim()));
                if (bRegex)
                // commented and added to make regex work on server side for dropdown list (select).
//                    oTable.fnFilter("^"+removeSpecialCharacters(unescape($.trim($(this).val())))+"$", iColumn, bRegex); //Issue 41
                    oTable.fnFilter(unescape($.trim($(this).val())), iColumn, bRegex); //Issue 41
                else
                    oTable.fnFilter(unescape($(this).val()), iColumn); //Issue 25
                fnOnFiltered();
            });
        }
        function removeSpecialCharacters(pattern) {
